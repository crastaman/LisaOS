...
| No automated decision-consumption pipeline exists (see `10_DECISION_CONSUMPTION_MODEL.md`) | None (not a risk) | Explicitly out of scope — the absence of a consumer is what keeps Console's execution-incapability trivially true today. Not a gap to close, a property to preserve. |
